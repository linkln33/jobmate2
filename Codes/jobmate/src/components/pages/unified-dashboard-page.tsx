...
export function UnifiedDashboardPage() {
  ...
  const verificationLevel = 1; // 0-3 scale
    ...
    <UnifiedDashboardLayout title="Dashboard" showMap={false}>
      ...
      <div className="p-6">
        ...
        {showVerificationBanner && (
          <GlassCard intensity="high" className="mb-6 relative">
            <Button 
              variant="ghost" 
              size="icon" 
            ...
            <GlassCardContent className="p-4">
              <div className="flex items-center">
                <Shield className="h-8 w-8 text-amber-500 mr-4" />
                <div className="flex-1">
                  <h3 className="text-sm font-medium">Complete your verification</h3>
                  <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                    {verificationLevel === 0 ? 'Start the verification process to unlock more features.' : 
                     `You've completed ${verificationLevel} of 3 verification steps.`}
                  </p>
                  <Progress value={verificationProgress} className="h-1 mt-2" />
                </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
          {/* Quick Overview */}
          <GlassCard className="col-span-12 lg:col-span-12">
            <GlassCardHeader>
              <GlassCardTitle>Quick Overview</GlassCardTitle>
            </GlassCardHeader>
            <GlassCardContent>
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                <div className="flex flex-col items-center justify-center p-4 rounded-lg bg-white/10 dark:bg-gray-800/20">
          ...
          {/* Interactive Map */}
          <GlassCard className="col-span-12 lg:col-span-12 mb-6">
            <GlassCardHeader>
              <GlassCardTitle>Service Map</GlassCardTitle>
            </GlassCardHeader>
          ...
          {/* Upcoming Jobs */}
          <GlassCard intensity="medium" className="col-span-full md:col-span-1">
            ...
            <GlassCardContent>
              <div className="space-y-4">
                {upcomingJobs.map(job => (
                  <div key={job.id} className="flex items-center p-3 rounded-lg bg-white/10 dark:bg-gray-800/20">
          ...
          {/* Recent Activity */}
          <GlassCard className="col-span-1 md:col-span-1 lg:col-span-1">
            <GlassCardHeader>
            ...
            <GlassCardContent>
              <Tabs defaultValue="jobs" className="w-full">
                ...
                <TabsContent value="jobs" className="space-y-4">
                  {upcomingJobs.map(job => (
                    <div key={job.id} className="flex items-center justify-between p-3 rounded-lg bg-white/10 dark:bg-gray-800/20">
                      <div className="flex items-center">
                ...
                <TabsContent value="services" className="space-y-4">
                  <div className="flex items-center justify-between p-3 rounded-lg bg-white/10 dark:bg-gray-800/20">
                    <div className="flex items-center">
                      <div className="bg-green-100 dark:bg-green-900/30 p-2 rounded-full mr-3">
                        <MapPin className="h-4 w-4 text-green-600 dark:text-green-300" />
                      </div>
                      <div>
                        <p className="text-sm font-medium">Home Cleaning Service</p>
                  ...
                  <div className="flex items-center justify-between p-3 rounded-lg bg-white/10 dark:bg-gray-800/20">
                    <div className="flex items-center">
                      ...
                      <div>
                        <p className="text-sm font-medium">Lawn Maintenance</p>
                ...
                <TabsContent value="products" className="space-y-4">
                  <div className="flex items-center justify-between p-3 rounded-lg bg-white/10 dark:bg-gray-800/20">
                    <div className="flex items-center">
                      ...
                      <div>
                        <p className="text-sm font-medium">Cleaning Supplies Kit</p>
                        <p className="text-xs text-gray-500 dark:text-gray-400">New product listing</p>
                      </div>
                    </div>
                    <Badge variant="outline">New</Badge>
                  </div>
                  <div className="flex items-center justify-between p-3 rounded-lg bg-white/10 dark:bg-gray-800/20">
                    <div className="flex items-center">
                      ...
                      <div>
                        <p className="text-sm font-medium">Garden Tools Set</p>
