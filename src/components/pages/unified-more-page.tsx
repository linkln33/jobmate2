...
export function UnifiedMorePage() {
  ...
  return (
    <UnifiedDashboardLayout title="More Options - JobMate" showMap={false}>
      <div className="container max-w-4xl mx-auto px-4 py-6">
          ...
          {menuItems.map((item) => (
            <Link
              ...
              className={cn(
                ...
                "bg-white dark:bg-gray-800 hover:bg-brand-50 dark:hover:bg-gray-700 shadow-sm"
              )}
            >
              <div className="flex items-center">
                <div className="bg-brand-50 dark:bg-gray-700 p-2 rounded-full">
                  {item.icon}
                </div>
                <div className="ml-4">
        ...
        <button
          ...
          className="w-full mt-6 flex items-center justify-center p-4 rounded-lg bg-red-50 dark:bg-red-900/20 text-red-600 dark:text-red-400 hover:bg-red-100 dark:hover:bg-red-900/30 transition-colors"
        >
